...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Força o gráfico a descer um pouco abaixo do 0 para a linha vermelha aparecer bem
    final minYScale = minSpotY >= 0 ? -(paddingY * 0.5) : minSpotY - paddingY;
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: LineChart(LineChartData(
                                  // ADICIONADO: LINHA VERMELHA MARCANTO O ZERO!
