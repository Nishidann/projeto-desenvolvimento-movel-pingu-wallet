...
Aplicativo de gestão financeira pessoal desenvolvido em **Flutter**, focado em oferecer controle total sobre receitas e despesas com uma interface intuitiva e moderna baseada em **Material 3**.
...
* **Comunicação**: HTTP (Consumo de API RESTful)
